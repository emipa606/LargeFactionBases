...
public class GenStep_LargeFactionBase2 : GenStep
{
    ...
    private FloatRange defaultPawnGroupPointsRange = SymbolResolver_Settlement2.DefaultPawnsPoints;
    ...
    public override void Generate(Map map, GenStepParams parms)
    {
        ...
        if ((num21 < 0.7f) & ((int)resolveParams.faction.def.techLevel > 3))
        {
            ...
            rect.Width = Mathf.Clamp(rect.Width, 1, Mathf.Min(rect.Width, rect.Height) / 2);
        ...
        if ((num21 >= 0.7f) & ((int)resolveParams.faction.def.techLevel > 3))
        {
            ...
            rect2.Width = Mathf.Clamp(rect2.Width, 1, Mathf.Min(rect2.Width, rect2.Height) / 2);
            ...
            rect3.Width = Mathf.Clamp(rect3.Width, 1, Mathf.Min(rect3.Width, rect3.Height) / 2);
        ...
        if ((num21 < 0.7f) & ((int)resolveParams.faction.def.techLevel <= 3))
        {
            ...
            rect6.Width = Mathf.Clamp(rect6.Width, 1, Mathf.Min(rect6.Width, rect6.Height) / 2);
            ...
            rect7.Width = Mathf.Clamp(rect7.Width, 1, Mathf.Min(rect7.Width, rect7.Height) / 2);
